...
from .views import HomeView, trips_list, TripDeleteView, TripUpdateView, NoteDeleteView, NoteUpdateView, NoteCreateView, TripCreateView, TripDetailView, NoteDetailView, NoteListView
...
urlpatterns = [
    ...
    path('dashboard/trip/<int:pk>/',
         TripDetailView.as_view(), name='trip-detail'),
